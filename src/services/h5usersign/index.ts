...
/** H5UserPresignRequestH5 预申请签约接口请求 */
...
/** H5UserPresignResponseH5 预申请签约接口返回 */
...
/** H5UserSignResponseH5 签约接口返回 */
interface H5UserSignResponse {
  /** H5 签约页面 URL */
  url: string
}

/** GetH5UserSignStatusRequest获取用户签约状态请求 */
...
/** GetH5UserSignStatusResponse获取用户签约状态返回 */
