...
/** BankCardFourAuthVerifyRequest银行卡四要素鉴权请求 */
...
/** BankCardFourAuthVerifyResponse银行卡四要素鉴权返回 */
interface BankCardFourAuthVerifyResponse {
  /** 交易凭证 */
  ref: string
}

/** BankCardFourAuthConfirmRequest银行卡四要素确认鉴权请求 */
...
/** BankCardFourAuthConfirmResponse银行卡四要素确认鉴权返回 */
interface BankCardFourAuthConfirmResponse {}

/** BankCardFourVerifyRequest银行卡四要素验证请求 */
...
/** BankCardFourVerifyResponse银行卡四要素验证返回 */
interface BankCardFourVerifyResponse {}

/** BankCardThreeVerifyRequest银行卡三要素验证请求 */
...
/** BankCardThreeVerifyResponse银行卡三要素验证返回 */
interface BankCardThreeVerifyResponse {}

/** IDCardVerifyRequest身份证实名验证请求 */
...
/** IDCardVerifyResponse身份证实名验证返回 */
interface IDCardVerifyResponse {}

/** UserExemptedInfoRequest上传免验证用户名单信息请求 */
...
/** UserExemptedInfoResponse上传免验证用户名单信息返回 */
interface UserExemptedInfoResponse {
  /** 是否上传成功 */
  ok: string
}

/** UserWhiteCheckRequest查看免验证用户名单是否存在请求 */
...
/** UserWhiteCheckResponse查看免验证用户名单是否存在返回 */
interface UserWhiteCheckResponse {
  ok: boolean
}

/** GetBankCardInfoRequest银行卡信息查询请求 */
...
/** GetBankCardInfoResponse银行卡信息查询返回 */
