...
/** ApiUseSignContractRequest获取协议预览 URL 请求 */
...
/** ApiUseSignContractResponse获取协议预览 URL 返回 */
...
/** ApiUserSignResponse用户签约返回 */
interface ApiUserSignResponse {
  /** 是否签约成功 */
  status: string
}

/** GetApiUserSignStatusRequest获取用户签约状态请求 */
...
/** GetApiUserSignStatusResponse获取用户签约状态返回 */
...
/** ApiUserSignReleaseRequest用户解约请求 */
...
/** ApiUserSignReleaseResponse用户解约返回 */
